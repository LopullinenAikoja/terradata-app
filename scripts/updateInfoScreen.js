function updateInfoScreen(prop){
	...
	// require(["dojo/ready", "dijit/form/ToggleButton"], function(ready, ToggleButton){
		...
		//call pinMap pinMap.js
		pinMap(prop);
		
		//update the map, updateMap.js
		updateMap(prop);
		...
		addressRow.setAttribute("height", "30");
		...
		coordinatesRow.setAttribute("height", "30");
		...
		landuseRow.setAttribute("height","30");
		...
		acerageRow.setAttribute("height", "30");
		...
		assesmentRow.setAttribute("height", "30");
		...
		ownerRow.setAttribute("height", "30");
		...
		bookRow.setAttribute("height", "30");
		...
		pageRow.setAttribute("height", "30");
		...
		townRow.setAttribute("height", "30");
		...
		lsdateRow.setAttribute("height", "30");
		...
		lspriceRow.setAttribute("height", "30");
		...
		zoningRow.setAttribute("height", "30");
		...
		wetcodeRow.setAttribute("height", "30");
		...
		areaAcresRow.setAttribute("height", "30");
		...
		dpNoteRow.setAttribute("height", "30");
		...
		dpStatusRow.setAttribute("height", "30");
		...
		wetlands.state = $("#stateSelect").val();
		...
		//alert(wetlandsNum);
		$( "#downloadParcelInfoDiv" ).show();
		$( "#newParcelInfoTabDiv" ).show();
	}
